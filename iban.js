var IBAN = (function () {
  ...
  function e(r) {
      var n = (r = a(r)).substr(0, 2),
          t = r.substr(2, 2),
          u = r.substr(4, 20) + h(n) + t;
  ...
  function h(r) {
      for (var n = [], t = 0; t < r.length; t++) {
          var u = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(r[t]);
          n.push(u < 0 ? "-" : u);
      }
      return n.join("");
  }
  return {
      convertir: function (r, n) {
          var t = (r = a(r)).substr(r.length - 24, 24),
              u = r.substr(r.length - 20, 20);
          return l(r) || f(r) ? (l(r) && !e(t) ? "Error: IBAN incorrecto" : s(u) ? (l(r) ? c(t) : c(o(u, n))) : "Error: CCC incorrecto") : "Error: No es IBAN ni CCC";
      },
      calcular: function (r, n) {
          if (f((r = a(r)))) {
              var t = r.substr(8, 2);
      ...
      validar: function (r) {
          return l((r = a(r))) ? e(r) : !!f(r) && s(r);
      },
      formatear: function (r, n) {
          return l((r = a(r)))
              ? c(r, n)
              : f(r)
              ? i(r, n)
...
principales_espanya = [
  ...
  { codigo: "0182", nombre: "BBVA", bic: "BBVA" },
  { codigo: "0081", nombre: "Banc Sabadell", bic: "BSAB" },
  { codigo: "0049", nombre: "Banco Santander", bic: "BSAB" },
  { codigo: "2038", nombre: "Bankia", bic: "CAHM" },
  { codigo: "0128", nombre: "Bankinter", bic: "BKBK" },
  { codigo: "2103", nombre: "Unicaja", bic: "UCJA" },
  { codigo: "2085", nombre: "Ibercaja", bic: "CAZR" },
  { codigo: "2095", nombre: "Kutxabank", bic: "BASK" },
  { codigo: "2080", nombre: "Abanca", bic: "CAGL" },
  { codigo: "2048", nombre: "Liberbank", bic: "CECA" },
];
principales_espanya.sort(function (o, a) {
var i = o.nombre.toLowerCase(),
  n = a.nombre.toLowerCase();
return i < n ? -1 : n < i ? 1 : 0;
});
var principales_espanya_dict = {};